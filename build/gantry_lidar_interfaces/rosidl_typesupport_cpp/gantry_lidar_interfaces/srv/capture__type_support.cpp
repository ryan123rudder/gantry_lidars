...
static const _Capture_Request_type_support_symbol_names_t _Capture_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gantry_lidar_interfaces, srv, Capture_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gantry_lidar_interfaces, srv, Capture_Request)),
  }
};
...
{
  return &::gantry_lidar_interfaces::srv::rosidl_typesupport_cpp::Capture_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gantry_lidar_interfaces, srv, Capture_Request)() {
  return get_message_type_support_handle<gantry_lidar_interfaces::srv::Capture_Request>();
}
...
static const _Capture_Response_type_support_symbol_names_t _Capture_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gantry_lidar_interfaces, srv, Capture_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gantry_lidar_interfaces, srv, Capture_Response)),
  }
};
...
{
  return &::gantry_lidar_interfaces::srv::rosidl_typesupport_cpp::Capture_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gantry_lidar_interfaces, srv, Capture_Response)() {
  return get_message_type_support_handle<gantry_lidar_interfaces::srv::Capture_Response>();
}
...
typedef struct _Capture_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _Capture_Event_type_support_ids_t;

static const _Capture_Event_type_support_ids_t _Capture_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _Capture_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _Capture_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _Capture_Event_type_support_symbol_names_t _Capture_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gantry_lidar_interfaces, srv, Capture_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gantry_lidar_interfaces, srv, Capture_Event)),
  }
};

typedef struct _Capture_Event_type_support_data_t
{
  void * data[2];
} _Capture_Event_type_support_data_t;

static _Capture_Event_type_support_data_t _Capture_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _Capture_Event_message_typesupport_map = {
  2,
  "gantry_lidar_interfaces",
  &_Capture_Event_message_typesupport_ids.typesupport_identifier[0],
  &_Capture_Event_message_typesupport_symbol_names.symbol_name[0],
  &_Capture_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t Capture_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_Capture_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::gantry_lidar_interfaces::srv::rosidl_typesupport_cpp::Capture_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gantry_lidar_interfaces, srv, Capture_Event)() {
  return get_message_type_support_handle<gantry_lidar_interfaces::srv::Capture_Event>();
}
...
static const _Capture_type_support_symbol_names_t _Capture_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gantry_lidar_interfaces, srv, Capture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gantry_lidar_interfaces, srv, Capture)),
  }
};
...
static const rosidl_service_type_support_t Capture_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<gantry_lidar_interfaces::srv::Capture_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<gantry_lidar_interfaces::srv::Capture_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<gantry_lidar_interfaces::srv::Capture_Event>(),
...
{
  return &::gantry_lidar_interfaces::srv::rosidl_typesupport_cpp::Capture_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, gantry_lidar_interfaces, srv, Capture)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<gantry_lidar_interfaces::srv::Capture>();
}
